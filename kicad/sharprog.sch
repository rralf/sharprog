...
U 1 1 5F76A8F2
P 11000 1500
F 0 "J1" H 11108 2181 50  0000 C CNN
F 1 "Conn_01x11_Male" H 11108 2090 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x11_P2.54mm_Horizontal" H 11000 1500 50  0001 C CNN
...
Text GLabel 10600 1000 0    50   3State ~ 0
MTOUT2
$Comp
L power:+6V #PWR0101
U 1 1 5F778013
P 9450 1000
F 0 "#PWR0101" H 9450 850 50  0001 C CNN
...
Wire Wire Line
	9450 1000 9450 1100
Wire Wire Line
	9450 1100 10800 1100
$Comp
L Diode:1N4148 D2
U 1 1 5F77CFE5
P 9450 1500
F 0 "D2" V 9404 1580 50  0000 L CNN
F 1 "1N4148" V 9495 1580 50  0000 L CNN
F 2 "Diode_SMD:D_MiniMELF" H 9450 1325 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 9450 1500 50  0001 C CNN
	1    9450 1500
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 5F778BD2
P 9050 1300
F 0 "#PWR0102" H 9050 1050 50  0001 C CNN
F 1 "GND" H 8972 1263 50  0000 R CNN
F 2 "" H 9050 1300 50  0001 C CNN
F 3 "" H 9050 1300 50  0001 C CNN
	1    9050 1300
	1    0    0    -1  
$EndComp
Text GLabel 10600 2000 0    50   BiDi ~ 0
IB5
...
U 1 1 5F789DC9
P 9250 1500
F 0 "D1" V 9296 1580 50  0000 L CNN
F 1 "1N4148" V 9205 1580 50  0000 L CNN
F 2 "Diode_SMD:D_MiniMELF" H 9250 1325 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 9250 1500 50  0001 C CNN
	1    9250 1500
	0    -1   -1   0   
$EndComp
Wire Wire Line
	10800 1500 9600 1500
Wire Wire Line
	9600 1500 9600 1750
Wire Wire Line
	9600 1750 9450 1750
...
U 1 1 5F79003D
P 8800 1750
F 0 "C1" V 8548 1750 50  0000 C CNN
...
U 1 1 5F793AC4
P 9400 2000
F 0 "R1" V 9515 2000 50  0000 C CNN
F 1 "330k" V 9606 2000 50  0000 C CNN
...
U 1 1 5F795460
P 8800 2000
F 0 "C2" V 8960 2000 50  0000 C CNN
F 1 "100n" V 9051 2000 50  0000 C CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 8838 1850 50  0001 C CNN
...
U 1 1 5F7972D6
P 9050 2250
F 0 "R3" H 8980 2204 50  0000 R CNN
F 1 "10k" H 8980 2295 50  0000 R CNN
...
$EndComp
$Comp
L sharprog-rescue:USB_B_Micro-Connector J2
U 1 1 5F79006F
P 800 5850
...
U 1 1 5F81157A
P 7550 1750
F 0 "D3" H 7550 1533 50  0000 C CNN
F 1 "1N4148" H 7550 1624 50  0000 C CNN
F 2 "Diode_SMD:D_MiniMELF" H 7550 1575 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 7550 1750 50  0001 C CNN
	1    7550 1750
	-1   0    0    1   
$EndComp
Wire Wire Line
...
F 1 "1k" V 8234 2250 50  0000 C CNN
...
U 1 1 5F81F11A
P 8350 2450
F 0 "#PWR0115" H 8350 2200 50  0001 C CNN
...
U 1 1 5F7A69DD
P 8350 850
F 0 "J4" V 8336 1038 50  0000 L CNN
F 1 "AudioJack2_SwitchT" V 8427 1038 50  0000 L CNN
F 2 "Custom:3.5mm_narrow" H 8350 850 50  0001 C CNN
...
U 1 1 5F7AB75F
P 8350 1400
F 0 "R7" H 8419 1354 50  0000 L CNN
F 1 "100" H 8419 1445 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 8280 1400 50  0001 C CNN
...
U 1 1 5F7B4182
P 7900 850
F 0 "J3" V 7583 829 50  0000 C CNN
F 1 "AudioJack2_SwitchT" V 7674 829 50  0000 C CNN
F 2 "Custom:3.5mm_narrow" H 7900 850 50  0001 C CNN
